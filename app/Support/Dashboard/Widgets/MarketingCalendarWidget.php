...
class MarketingCalendarWidget extends AbstractWidgetProvider
{
    public function __construct(private readonly DashboardMetrics $metrics) {}

    public function data(WidgetContext $context): array
    {
        return ['events' => $this->metrics->marketingCalendar($context)];
    }

    public function view(): string
    {
        return 'admin.dashboard.widgets.marketing-calendar';
    }
}
