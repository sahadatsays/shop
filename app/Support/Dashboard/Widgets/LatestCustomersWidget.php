...
class LatestCustomersWidget extends AbstractWidgetProvider
{
    public function __construct(private readonly DashboardMetrics $metrics) {}

    public function data(WidgetContext $context): array
    {
        return ['customers' => $this->metrics->latestCustomers()];
    }

    public function view(): string
    {
        return 'admin.dashboard.widgets.latest-customers';
    }
}
