...
return [
    'groups' => [
        ...
        'Procurement' => [
            ...
            'suppliers.purchases.view' => 'View supplier purchase history',
    ...
    'roles' => [
        ...
        'purchase_manager' => [
            ...
            'description' => 'Create and manage purchase orders without approval or receiving rights.',
        ],
        'order_manager' => [
            'name' => 'Order Manager',
    ...
    'default_users' => [
        ...
        [
            'name' => 'Priya Sen',
            'email' => 'purchasing@valorsupply.co',
