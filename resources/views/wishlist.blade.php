    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14" data-wishlist>
        ...
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-4">
            ...
            <div class="lg:col-span-3">
                ...
                {{-- Grid --}}
                <ul data-wishlist-grid class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3" @if($summary->isEmpty()) hidden @endif>
                ...
                {{-- Empty state --}}
                <div data-wishlist-empty @class(['mx-auto max-w-md py-16 text-center', 'hidden' => ! $summary->isEmpty()])>
