<x-layouts.auth title="Sign In" description="Sign in to your Valor Supply Co. account — track orders, manage addresses, and shop premium veteran gear.">
    ...
    <div class="min-h-screen lg:grid lg:grid-cols-2" data-login>
        ...
        <div class="relative hidden overflow-hidden bg-navy-950 lg:block">
            <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?w=1400&q=80&auto=format&fit=crop"
                 alt="Veteran hiking through alpine terrain at golden hour"
                 class="absolute inset-0 size-full object-cover opacity-90"
                 loading="eager" width="1400" height="933">
            <div class="absolute inset-0 bg-linear-to-t from-navy-950 via-navy-950/40 to-navy-950/20" aria-hidden="true"></div>
            ...
            <div class="relative flex h-full flex-col justify-between p-12 xl:p-16">
                ...
                <div class="max-w-md animate-fade-in-up">
                    <p class="text-sm font-semibold tracking-widest text-bronze-400 uppercase">Veteran owned</p>
                    <blockquote class="mt-4 font-display text-3xl leading-snug font-bold text-white xl:text-4xl">
                        Gear built with the same discipline you carried in the field.
                    </blockquote>
                    <p class="mt-5 text-base leading-relaxed text-navy-200">
                        Join thousands of veterans and supporters who trust Valor for quality craftsmanship and giving back.
                    </p>
                </div>

                <p class="text-xs text-navy-400">5% of every purchase supports veteran transition programs.</p>
            </div>
        </div>
        ...
        <div class="flex min-h-screen flex-col">
            ...
            <div class="relative h-44 overflow-hidden lg:hidden">
                <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&q=70&auto=format&fit=crop"
            ...
            <div class="flex flex-1 flex-col justify-center px-6 py-10 sm:px-12 lg:px-16 xl:px-24">
                <div class="mx-auto w-full max-w-md animate-fade-in">
                    ...
                    <form class="mt-8 space-y-5 lg:mt-10" data-login-form method="POST" action="{{ route('login.store') }}" novalidate>
                        ...
                        <div class="relative">
                            <x-ui.input name="password" type="password" label="Password" autocomplete="current-password" placeholder="Enter your password" required />
                    ...
                    <div class="relative my-8">
                        ...
                        <p class="relative flex justify-center">
                            <span class="bg-surface px-4 text-xs font-medium tracking-wide text-navy-400 uppercase">Or continue with</span>
                        </p>
                    </div>
                    ...
                    <p class="mt-10 text-center text-sm text-navy-600">
                        New to Valor?
                        <a href="{{ route('register') }}" class="font-semibold text-navy-900 underline-offset-4 transition-colors duration-200 hover:text-bronze-600 hover:underline">
                            Create an account
                        </a>
                    </p>
                    ...
                    <p class="mt-8 text-center text-xs leading-relaxed text-navy-400">
                        ...
                        and
                        <a href="#" class="underline-offset-2 hover:text-navy-600 hover:underline">Privacy Policy</a>.
                    </p>
                </div>
            </div>
        </div>
