@php
    ...
    $faqPreview = [
        [
            ...
            'a' =>
                'Sign in to Order History or use the tracking link in your shipping email. Visit our Order Tracking page with your order number and email.',
        ],
        [
            'q' => 'What is your return policy?',
            'a' =>
                'Returns accepted within 30 days on unworn items in original packaging. US orders receive a prepaid return label via Order History.',
        ],
        [
            'q' => 'Do you offer a veteran discount?',
            'a' => 'Verified veterans and active-duty members receive 10% off with ID.me verification at checkout.',
        ],
        [
            'q' => 'How quickly will you respond?',
            'a' =>
                'We reply to contact form messages within one business day. Live chat and phone support are available during business hours.',
        ],
    ];
    ...
    $socialLinks = [
        [
            ...
            'href' => '#',
            'path' =>
                'M8 3h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8a5 5 0 0 1 5-5Zm4 5.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7ZM17 6.8a.8.8 0 1 0 0 1.6.8.8 0 0 0 0-1.6Z',
        ],
        [
            'name' => 'Facebook',
            'href' => '#',
        ...
        [
            ...
            'href' => '#',
            'path' =>
                'M21 8s-.2-1.4-.8-2c-.8-.8-1.6-.8-2-.9C15.4 5 12 5 12 5s-3.4 0-6.2.1c-.4.1-1.2.1-2 .9-.6.6-.8 2-.8 2S3 9.6 3 11.2v1.5C3 14.4 3.2 16 3.2 16s.2 1.4.8 2c.8.8 1.8.8 2.2.9 1.6.1 5.8.1 5.8.1s3.4 0 6.2-.1c.4-.1 1.2-.1 2-.9.6-.6.8-2 .8-2s.2-1.6.2-3.3v-1.5C21.2 9.6 21 8 21 8ZM10 14.6V9.4l5 2.6-5 2.6Z',
        ],
    ];
@endphp

<x-layouts.app title="Contact Us"
    description="Get in touch with Jackpot BD LTD — contact form, headquarters, business hours, and support information.">

    <div data-contact>

        {{-- Hero --}}
        <section class="relative overflow-hidden bg-navy-950">
            <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(176,137,104,0.12),transparent_55%)]"
            ...
            <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                ...
                <div class="mt-6 max-w-2xl">
                    ...
                    <h1 class="mt-3 font-display text-4xl font-bold tracking-tight text-white sm:text-5xl">Contact with
                        us
                    </h1>
                    <p class="mt-4 text-lg leading-relaxed text-navy-200">
                        Questions about an order, custom packaging, or printing? Our team is here to help with product
                        details, customization, pricing, and delivery. We typically respond within one business day.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="overflow-hidden rounded-card bg-surface shadow-soft">
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <div class="relative min-h-64 lg:col-span-2 lg:min-h-96">
                            <svg viewBox="0 0 800 420" class="block size-full min-h-64" role="img"
                                aria-label="Map showing Jackpot BD LTD headquarters in Springfield, Illinois">
                                <rect width="800" height="420" class="fill-navy-50" />
                                <rect x="80" y="60" width="140" height="100" rx="12"
                                    class="fill-olive-100" />
                                <rect x="520" y="240" width="160" height="100" rx="12"
                                    class="fill-olive-100" />
                                ...
                                <path d="M400 120c-18 0-32 14-32 32 0 22 32 48 32 48s32-26 32-48c0-18-14-32-32-32Z"
                                    class="fill-bronze-500" />
                                <circle cx="400" cy="152" r="10" class="fill-white" />
                            </svg>
                            <div
                                class="absolute inset-x-0 bottom-0 flex items-center justify-between bg-linear-to-t from-navy-900/75 to-transparent px-6 py-4">
                                <span class="text-sm font-medium text-white">Springfield, IL — Headquarters</span>
                                <span
                                    class="rounded-md bg-white/15 px-2.5 py-1 text-[0.65rem] font-semibold tracking-wide text-white uppercase backdrop-blur-sm">Maps
                                    API</span>
                            </div>
                        </div>
                        <div class="flex flex-col justify-center p-8 lg:p-10">
                            ...
                            <h2 class="mt-4 font-display text-xl font-bold text-navy-900">Jackpot BD LTD</h2>
                            <address class="mt-3 not-italic text-sm leading-relaxed text-navy-600">
                                1842 Veterans Parkway<br>
                                Springfield, IL 62704
                            </address>
                            <p class="mt-4 text-sm text-navy-500">Our workshop and fulfillment center. Showroom visits
                                available by appointment — email <a href="mailto:hello@valorsupply.co"
                                    class="font-medium text-bronze-600 hover:underline">hello@valorsupply.co</a>.</p>
                            <a href="https://maps.google.com/?q=Springfield+IL" target="_blank"
        ...
        <section class="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8 lg:pb-28" aria-labelledby="faq-preview-heading">
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div>
                    ...
                    <h2 id="faq-preview-heading" class="mt-2 font-display text-3xl font-bold text-navy-900">FAQ
                        preview</h2>
