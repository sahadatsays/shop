<x-layouts.auth title="Reset Password"
    description="Reset your Jackpot BD LTD account password — we'll send you a secure link by email.">
    ...
    <div class="flex min-h-screen flex-col items-center justify-center px-6 py-12" data-forgot-password>
        ...
        <div class="w-full max-w-md animate-fade-in">
            ...
            <div data-forgot-request>
                {{-- Illustration --}}
                <div class="mx-auto flex size-32 items-center justify-center rounded-full bg-navy-900/5"
                    aria-hidden="true">
                    <svg viewBox="0 0 120 120" class="size-24" fill="none" role="img"
                        aria-label="Password reset illustration">
                        <circle cx="60" cy="60" r="52" class="stroke-navy-100" stroke-width="2" />
                        <rect x="32" y="44" width="56" height="40" rx="6"
                            class="fill-surface stroke-navy-200" stroke-width="2" />
                        <path d="M32 50h56" class="stroke-navy-200" stroke-width="2" />
                        <path d="M60 44V34a12 12 0 0 0-12 12" class="stroke-bronze-500" stroke-width="2.5"
                        ...
                        <path d="M44 78c4 4 8 6 16 6s12-2 16-6" class="stroke-navy-300" stroke-width="1.5"
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-navy-600">
                        No worries — enter the email on your account and we’ll send a secure link to reset your
                        password.
                    </p>
                </div>

                <form class="mt-8 space-y-5" data-forgot-form method="POST" action="{{ route('password.email') }}"
                    novalidate>
                    @csrf
            ...
            <div data-forgot-success hidden class="text-center">
                <div class="mx-auto flex size-32 items-center justify-center rounded-full bg-olive-50"
                    aria-hidden="true">
                    <svg viewBox="0 0 120 120" class="size-24" fill="none" role="img"
                        aria-label="Email sent successfully">
                        <circle cx="60" cy="60" r="52" class="stroke-olive-200" stroke-width="2" />
                        <rect x="28" y="38" width="64" height="44" rx="6"
                            class="fill-surface stroke-olive-300" stroke-width="2" />
                        <path d="M28 44l32 22 32-22" class="stroke-olive-500" stroke-width="2"
                            stroke-linejoin="round" />
                        <circle cx="84" cy="76" r="16" class="fill-olive-600" />
                        <path d="M77 76l5 5 10-10" class="stroke-white" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </div>
