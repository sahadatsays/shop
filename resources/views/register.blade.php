<x-layouts.auth title="Create Account"
    description="Create your Jackpot BD LTD account — shop premium veteran gear, track orders, and join our community.">
    ...
    <div class="min-h-screen lg:grid lg:grid-cols-2" data-register>
        ...
        <div class="relative hidden overflow-hidden bg-navy-950 lg:block">
            <img src="{{ $banner ?? asset('storage/login/login-banner.png') }}"
            ...
            <div class="absolute inset-0 bg-linear-to-t from-navy-950 via-navy-950/50 to-navy-950/20"
            ...
            <div class="relative flex h-full flex-col justify-between p-12 xl:p-16">
                ...
                <div class="max-w-md animate-fade-in-up">
                    ...
                    <blockquote class="mt-4 font-display text-3xl leading-snug font-bold text-white xl:text-4xl">
                        Your account. Your orders. One place for everything in Jackpot BD.
                    </blockquote>
                    <ul class="mt-6 space-y-3 text-sm text-navy-200">
                        <li class="flex items-center gap-3">
                            <span
                                class="flex size-6 shrink-0 items-center justify-center rounded-full bg-bronze-500/20 text-bronze-400">
        ...
        <div class="flex min-h-screen flex-col">
            ...
            <div class="relative h-40 overflow-hidden lg:hidden">
                <img src="{{ $banner ?? asset('storage/login/login-banner.png') }}" alt=""
            ...
            <div class="flex flex-1 flex-col justify-center px-6 py-10 sm:px-12 lg:px-16 xl:px-24">
                <div class="mx-auto w-full max-w-md animate-fade-in">
                    <div class="hidden lg:block">
                        <h1 class="font-display text-3xl font-bold tracking-tight text-navy-900">Create your account
                        </h1>
                        <p class="mt-2 text-navy-600">A few details and you’re ready to shop, track, and earn rewards.
                        </p>
                    </div>

                    <form class="mt-8 space-y-4 lg:mt-10" data-register-form method="POST"
                        action="{{ route('register.store') }}" novalidate>
                        @csrf
                        <x-ui.input name="name" label="Full name" autocomplete="name" placeholder="Manchur Iqbal"
                            required />

                        <x-ui.input name="email" type="email" label="Email address" autocomplete="email"
                            placeholder="you@example.com" required />

                        <x-ui.input name="phone" type="tel" label="Phone number" autocomplete="tel"
                            placeholder="+880 123 4567 234" hint="For delivery updates and order support." required />
                        ...
                        <div class="relative">
                            <x-ui.input name="password-confirm" type="password" label="Confirm password"
                                autocomplete="new-password" placeholder="Re-enter your password" required />
                            <button type="button" data-toggle-password="password-confirm"
                            ...
                            <p class="mt-1.5 hidden text-sm text-red-600" data-password-mismatch role="alert">
                        ...
                        <div class="space-y-3 pt-2">
                            <label class="flex cursor-pointer items-start gap-3">
                                ...
                                <span class="text-sm leading-relaxed text-navy-700">
                                    Send me the Jackpot newsletter — new arrivals, Hot offers, and exclusive deals. I
                            ...
                            <label class="flex cursor-pointer items-start gap-3">
                                ...
                                <span class="text-sm leading-relaxed text-navy-700">
                                    I agree to the
                                    <a href="#"
                                        class="font-medium text-navy-900 underline-offset-2 hover:text-bronze-600 hover:underline">Terms
                                        of Service</a>
                                    and
                                    <a href="#"
                                        class="font-medium text-navy-900 underline-offset-2 hover:text-bronze-600 hover:underline">Privacy
                                        Policy</a>.
                                </span>
                            </label>
                        </div>
